# =========================================
# Diddyblud Store — Modul yang digunakan
# =========================================
# Modul 1: Variabel, Tipe Data, Array → saldo, daftar game (list), keranjang (dict), harga aktif/asli (dict)
...
class Cart:
    # items = {title: {"qty": int, "price": int, "cover": str}}
    def __init__(self):
        self.items = {}
...
class StoreApp:
    def __init__(self, root, initial_balance=500000):
        ...
        tk.Label(header, text="🎮 Diddyblud Store", font=font(size=28, weight="bold"), bg="#1e1e2f", fg="#ffd700").pack(side="left", padx=22, pady=18)
    ...
    # Checkout & Struk sederhana (scroll daftar) (Modul 8)
    ...
    def show_receipt(self, purchased_summary, spin_count):
        # Versi sederhana: daftar item scrollable (tanpa panel responsive kanan)
        win = tk.Toplevel(self.root)
    ...
    # Lucky Spin dengan animasi + anti spin tak terbatas (Modul 2, 3, 8)
...
class BalanceMenu:
    def __init__(self, root, default_balance=500000, on_start=None):
        ...
        tk.Label(header, text="🎉 Selamat Datang di Diddyblud Store", font=font(size=18, weight="bold"), fg="#FFD700", bg="#121225").pack()
